...
export default function HomePage() {
  ...
  // ✅ Gestion complète des images vides ou nulles
  const getImageSrc = (url: string | null | undefined) => {
    if (!url || url.trim() === "") return "/images/image1.jpg"; // image par défaut
          ...
          {produits.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
              {produits.map((produit) => {
                ...
                if (produit.categorie?.toLowerCase() === "femme") categoriePath = "femme";
                if (produit.categorie?.toLowerCase() === "enfant") categoriePath = "enfants";
                if (produit.categorie?.toLowerCase() === "lentilles") categoriePath = "lentilles";
